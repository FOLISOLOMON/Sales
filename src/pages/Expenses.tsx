        ...
        <div className="grid grid-cols-2 gap-3">
          <Card className="border-border/50">
            <CardContent className="py-4">
              ...
              <p className="mt-2 text-xl font-bold text-destructive">{formatCurrency(totalExpenses, currency)}</p>
            </CardContent>
          </Card>
        ...
        <CardContent className="space-y-2">
          {loading ? (
            ...
            expenses.map((expense) => (
              <div key={expense.Expense_ID} className="flex items-start justify-between gap-3 rounded-xl border border-border/50 bg-muted/30 px-3 py-2.5">
